...
export default function ContactUsBlock() {
  ...
  return (
    ...
    >
      {/* subtle background band with brand accent line */}
      <div
        className="
          absolute inset-0
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2">
            ...
            <span className="text-xs tracking-wide uppercase text-gray-500">Contact Us</span>
          </div>
          <h2 id="contact-sales-title" className="mt-2 text-2xl md:text-3xl font-bold">
            Let’s talk about your AI compliance rollout
          </h2>
          <p className="mt-2 text-gray-600">
            Tell us a bit about your use case—security & compliance experts will respond within one business day.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-6 items-stretch">
            ...
            <div className="h-full rounded-2xl border bg-white/80 backdrop-blur-sm p-6 shadow-sm">
              <ul className="space-y-4 text-sm">
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-block h-2 w-2 rounded-full" style={{ backgroundColor: '#06B6D4' }} />
                  <div>
                    <div className="font-medium">Compliance-first</div>
                    <div className="text-gray-600">GDPR/PII redaction, allow/deny rules, audit exports.</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Drop-in with OpenAI & Azure OpenAI—no app rewrites.</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-block h-2 w-2 rounded-full bg-gray-300" />
                  <div>
                    ...
                    <div className="text-gray-600">Escalate risky prompts for approval before release.</div>
                  </div>
                </li>
              </ul>
              ...
              <div className="mt-6 pt-6 border-t">
                <div className="text-xs text-gray-500">
                  By submitting, you agree to be contacted about your request. We don’t train on your data.
                </div>
              </div>
            </div>
          </aside>
          ...
          <div className="md:col-span-3">
            ...
            >
              ...
              <div className="mt-4">
                <label className="block text-sm text-gray-600 mb-1">What are you solving?</label>
                <textarea
                  name="message"
                  rows={5}
